...
class NotificationsService:
    ...
    async def get_user_notifications(self, user_id: int, unread_only: bool = False) -> list[NotificationResponse]:
    ...
    async def create_notification(self, user_id: int, type: str, message: str, reference: dict | None = None) -> Notification:
